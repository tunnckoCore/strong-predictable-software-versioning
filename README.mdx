import H1Comp from './em.jsx';
// or
// import H1Comp from 'https://raw.githubusercontent.com/tunnckoCore/strong-predictable-software-versioning/tunnckoCore-patch-1/em.jsx';

# Strong Predictable Software Versioning (DRAFT)
Strong, easy and predictable, date-based software versioning. Similar to SemVer.

<H1Comp>okkkkkk</H1Comp>
